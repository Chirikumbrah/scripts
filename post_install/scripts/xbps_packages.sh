...
sudo xbps-install -Suy ffmpeg obs ffscreencast ranger unrar tar p7zip p7zip-unrar lm_sensors i3lock-color mtools docker tree qt6ct qt5ct \
    ...
    font-adobe-utopia-100dpi font-adobe-utopia-75dpi font-misc-misc terminus-font noto-fonts-ttf-extra \
    ...
    zathura zathura-pdf-mupdf zathura-cb zathura-djvu zathura-ps sl exa bat
